import { BookOpen, HelpCircle, MessageCircle, Mic, Zap } from 'lucide-react'
        ...
        <div className="mx-auto max-w-2xl space-y-6">
            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-xl border border-neutral-100 bg-neutral-50 p-4">
                ...
                <p className="mt-1 text-xs leading-relaxed text-neutral-500">
                  ...
                  目前性价比最高的中文友好大模型服务。请自行前往 DeepSeek 开放平台注册并购买 API 额度。
                  费用极低，日常写作练习每月仅需几元钱。
                </p>
          ...
          <section className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm sm:p-6">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-medium text-neutral-900">为什么 AI 辅助英语写作是最佳学习路径</h2>
            </div>
            <p className="mt-3 text-sm leading-relaxed text-neutral-600">
            ...
            <p className="mt-2 text-sm leading-relaxed text-neutral-600">
              AI 改变了这一切：你提交一篇文章，
              <span className="font-medium text-neutral-900">几秒钟内就能收到语法纠错、词汇优化建议和雅思标准评分</span>。
          ...
          <section className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="rounded-xl border border-neutral-100 bg-neutral-50 p-4">
                <div className="flex items-center gap-2">
                  <MessageCircle size={16} className="text-neutral-500" />
                  <h3 className="text-sm font-medium text-neutral-800">Gemini Live</h3>
                </div>
                <p className="mt-1.5 text-xs leading-relaxed text-neutral-500">
                  Google Gemini 的实时对话功能同样是优秀的 AI 口语训练工具。
                  它的优势在于完全免费，且对英语学习场景做了专门优化，非常适合日常练习。
                </p>
              </div>
            </div>
            <p className="mt-3 text-xs text-neutral-400">
              建议学习节奏：每天在本网站完成一篇写作 → 用 ChatGPT/Gemini 进行 15 分钟口语练习，读写 + 口语同步推进。
            </p>
          </section>
          ...
          <section className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm sm:p-6">
            <div className="flex items-center gap-2">
              <BookOpen size={18} className="text-neutral-500" />
              <h2 className="text-sm font-medium text-neutral-900">一个值得记住的认知</h2>
            </div>
            <div className="mt-4 rounded-xl bg-neutral-50 border border-neutral-100 p-5 text-center">
              <p className="text-xs uppercase tracking-wider text-neutral-400">核心认知</p>
              <p className="mt-3 font-sans text-lg font-semibold leading-relaxed text-neutral-900">
                记住雅思 <span className="text-xl">7000</span> 词，
                <br />
                就能看懂文章的 <span className="text-xl">90%–95%</span>。
              </p>
              <p className="mt-4 text-sm leading-relaxed text-neutral-600">
                这是一个<span className="font-medium text-neutral-900">投入产出比极高</span>的投资。
                7000 个单词听起来很多，但如果每天背 20 个新词并复习旧词，一年之内就能完成。
                一年之后，你会发现大部分英文内容——新闻、论文、小说、电影字幕——都不再需要频繁查字典。
              </p>
              <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                与此同时，AI 写作工具让这些单词<span className="font-medium text-neutral-900">从认知词汇转变为运用词汇</span>——
                你在写作中真正用出来的词，永远不会忘记。
              </p>
            </div>
