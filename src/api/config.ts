...
export const API_PATHS = {
  ...
  admin: {
    ...
    accessLogStatsDevices: '/admin/access-logs/stats/devices',
    ...
    writingTopics: '/admin/writing-topics',
    writingTopicById: (id: number | string) => `/admin/writing-topics/${id}`,
    writingTopicsBatch: '/admin/writing-topics/batch',
    writingTopicsImport: '/admin/writing-topics/import',
    writingTopicsGenerate: '/admin/writing-topics/generate',
    writingTopicsTemplate: '/admin/writing-topics/template',
